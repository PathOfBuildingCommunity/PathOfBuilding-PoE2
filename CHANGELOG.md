...
## [beta](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/tree/beta) (2026/09/25)
...
- Export 0.5.5 data and update trade data [\#2505](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2505) ([vaisest](https://github.com/vaisest))
- Add individual skill weapon set handling [\#2498](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2498) ([LocalIdentity](https://github.com/LocalIdentity))
- Parse desecrated flag from imported items [\#2507](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2507) ([vaisest](https://github.com/vaisest))
- Add support for Onslaught on Kill essence [\#2510](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2510) ([vaisest](https://github.com/vaisest))
- Improve tree tab performance [\#2492](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2492) ([vaisest](https://github.com/vaisest))
- Add Rune influenced mods to crafter [\#2509](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2509) ([vaisest](https://github.com/vaisest))
- Add support for Runeforged/mastered unique variants [\#2511](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2511) ([vaisest](https://github.com/vaisest))
### User Interface
...
- Fix Turning of the Seasons not applying Exposure [\#2516](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2516) ([Visp1024](https://github.com/Visp1024))
...
- Fix a bunch of unique export source files [\#2499](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/2499) ([vaisest](https://github.com/vaisest))
