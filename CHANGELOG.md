...
[Full Changelog](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/compare/v0.3.0...v0.4.1)

## What's Changed
### New to Path of Building
- Add Stormweaver Scouring Winds mod Support [\#495](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/495) ([Saeldur](https://github.com/Saeldur))
- fix 'Presence Present' notable and similar small nodes [\#492](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/492) ([ltogniolli](https://github.com/ltogniolli))
- Add support for parsing Grenade Damage, Area and Cooldown mods [\#490](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/490) ([ltogniolli](https://github.com/ltogniolli))
- Added validation for the existence of stats in passive skills, active skills, and mods [\#488](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/488) ([trompetin17](https://github.com/justjuangui))
...
- Add support for "and protect me from Harm" Notable [\#512](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/512) ([nbrugger-tgm](https://github.com/nbrugger-tgm))
...
- Add support for misc mods in Uniques and Tree [\#554](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/554) ([Blitz54](https://github.com/Blitz54))
- Add support for additional Empowering effects [\#563](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/563) ([TPlant](https://github.com/PJacek))
- Add support for Curse AoE on Tree and Windscream Curse Delay mod [\#577](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/577) ([Blitz54](https://github.com/Blitz54))
- Add support for Threaded Light Woven Focus Spirit mod [\#595](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/595) ([PGDeve](https://github.com/PGDeve))
...
- Add support for Chronomancer Now and Again Ascendancy [\#604](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/604) ([igorwessel](https://github.com/igorwessel))
- Support for Overabundance limit mod [\#608](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/608) ([Nostrademous](https://github.com/Nostrademous))
- Add Shift + Ctrl + V to bypass item import confirmation box [\#624](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/624) ([LocalIdentity](https://github.com/LocalIdentity))
- Add support for Monk's  "Sunder my Enemies..." Invoker Ascendancy [\#625](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/625) ([Jonathan-Dang](https://github.com/Jonathan-Dang))
...
- Fix fallout from SimpleGraphic upgrade with wider Unicode support [\#372](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/372) ([zao](https://github.com/zao))
- Added Times Stunned Recently and edited Warcries used Recently [\#637](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/637) ([Blitz54](https://github.com/Blitz54))
...
- Passive Tree Stuff [\#635](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/635) ([Blitz54](https://github.com/Blitz54))
- Added support for Minions "Life as extra ES" mod [\#655](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/655) ([Blitz54](https://github.com/Blitz54))
...
- Add support for Heroic Tragedy Timeless Jewel Keystones [\#621](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/621) ([Peechey](https://github.com/Peechey))
- Support for Stars Aligned node [\#656](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/656) ([Blitz54](https://github.com/Blitz54))
- Added Support for Attacks Gain Extra mods on Quivers [\#666](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/666) ([Blitz54](https://github.com/Blitz54))
- Added support for Reduced Bleeding Duration on you [\#667](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/667) ([Blitz54](https://github.com/Blitz54))
- Added support for Trephina always deals crits against heavy stunned [\#668](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/668) ([Blitz54](https://github.com/Blitz54))
- Added support for Svalinn lucky block [\#669](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/669) ([Blitz54](https://github.com/Blitz54))
- Added support for 25% of spell mana cost converted to life cost [\#670](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/670) ([Blitz54](https://github.com/Blitz54))
- Added support for Skin of the Loyal overcap mods [\#672](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/672) ([Blitz54](https://github.com/Blitz54))
- Added support for Iron Will and Iron Grip [\#675](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/675) ([Blitz54](https://github.com/Blitz54))
- Added support for Attack Speed when on full mana [\#676](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/676) ([Blitz54](https://github.com/Blitz54))
- Added support for Regenerative Flesh node [\#681](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/681) ([Blitz54](https://github.com/Blitz54))
- Add support for +Total Cast Time on Comet's and Lightning Conduit [\#685](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/685) ([Peechey](https://github.com/Peechey))
...
- Add support for increased Movement Speed while affected by an Ailment [\#678](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/678) ([Blitz54](https://github.com/Blitz54))
- Added support for Minions resistances are equal to yours [\#679](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/679) ([Blitz54](https://github.com/Blitz54))
- Timeless Jewel Kalguur assets was added [\#689](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/689) ([trompetin17](https://github.com/justjuangui))
### Fixed Crashes
...
- Fix numbers not showing to correct decimal places in some UI modLines [\#551](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/551) ([QuickStick123](https://github.com/QuickStick123))
...
- Update "Dmg. per ailment" title and ailment DPS beakdown titles [\#569](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/569) ([pauloday](https://github.com/pauloday))
- Fix tooltips for passive node mods of type FLAG scaled by Hulking Form [\#580](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/580) ([Peechey](https://github.com/Peechey))
...
- Don't add stat comparisons for hovered gem quality if gem has no quality stats [\#653](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/653) ([etojuice](https://github.com/etojuice))
...
- Fix ES bypass regression from #552 [\#694](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/694) ([Edvinas-Smita](https://github.com/Edvinas-Smita))
- Fix gems not showing the correct stats on some parts [\#661](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/661) ([LocalIdentity](https://github.com/LocalIdentity))
### Fixed Behaviours
- Make Ice Bite work as intended [\#508](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/508) ([xspirus](https://github.com/xspirus))
...
- Reduce performance issues with Time-Lost Jewels [\#555](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/555) ([Peechey](https://github.com/Peechey))
...
- Fix Gamblesprint missing movement speed mod  [\#536](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/536) ([PGDeve](https://github.com/PGDeve))
...
- Improve EHP accuracy [\#552](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/552) ([Edvinas-Smita](https://github.com/Edvinas-Smita))
### Other changes
...
- Implement Quicksand Hourglass [\#683](https://github.com/PathOfBuildingCommunity/PathOfBuilding-PoE2/pull/683) ([igorwessel](https://github.com/igorwessel))
