...
local displayStats = {
	...
	{ stat = "ManaCost", label = "Mana Cost", fmt = "d", color = colorCodes.MANA, pool = "ManaUnreserved", compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaHasCost and not o.InfernalFlameMax end },
	{ stat = "ManaCost", label = "Infernal Flame Cost", fmt = "d", color = colorCodes.FIRE, compPercent = true, lowerIsBetter = true, condFunc = function(v,o) return o.ManaHasCost and o.InfernalFlameMax end },
	...
	{ },
	{ stat = "Mana", label = "Total Mana", fmt = "d", color = colorCodes.MANA, compPercent = true, modNames = { "Mana" }, ignoredSections = { "Base from Gear", "Inc. from Tree" }, condFunc = function(v,o) return not o.InfernalFlameMax end },
	{ stat = "InfernalFlameMax", label = "Infernal Flame", fmt = "d", color = colorCodes.FIRE, compPercent = true, breakdown = "InfernalFlameMax" },
	{ stat = "InfernalFlame", label = "Current Infernal Flame", fmt = "d", color = colorCodes.FIRE, condFunc = function(v,o) return o.InfernalFlameMax end },
	{ stat = "InfernalFlameOverflowTaken", label = "Overflow Fire Taken", fmt = ".0f", color = colorCodes.FIRE, condFunc = function(v,o) return o.InfernalFlameOverflowTaken end, breakdown = "InfernalFlameOverflowTaken" },
	{ stat = "InfernalFlameOverflowLifeRecoupStacked", label = "Overflow Life Recoup", fmt = ".1f", color = colorCodes.LIFE, condFunc = function(v,o) return o.InfernalFlameOverflowTaken end, breakdown = "InfernalFlameOverflowLifeRecoupStacked" },
	{ stat = "InfernalFlameOverflowEnergyShieldRecoupStacked", label = "Overflow ES Recoup", fmt = ".1f", color = colorCodes.ES, condFunc = function(v,o) return o.InfernalFlameOverflowTaken end, breakdown = "InfernalFlameOverflowEnergyShieldRecoupStacked" },
	{ stat = "InfernalFlameOverflowLifeNetPerOverflow", label = "Net Life / Overflow", fmt = "+.0f", color = colorCodes.LIFE, condFunc = function(v,o) return o.InfernalFlameOverflowTaken end, breakdown = "InfernalFlameOverflowLifeNetPerOverflow" },
