...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Freeze Buildup", haveOutput = "FreezeBuildupOnHit", { format = "{1:output:FreezeBuildupOnHit}%",
		{ breakdown = "FreezeBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyFreezeBuildup", "EnemyImmobilisationBuildup"  } },
	}, },
	{ label = "Electrocute Buildup", haveOutput = "ElectrocuteBuildupOnHit", { format = "{1:output:ElectrocuteBuildupOnHit}%",
		{ breakdown = "ElectrocuteBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyElectrocuteBuildup", "EnemyImmobilisationBuildup"  } },
	}, },
	{ label = "Stun Buildup", haveOutput = "HeavyStunBuildupOnHit", { format = "{1:output:HeavyStunBuildupOnHit}%",
		{ breakdown = "HeavyStunBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyHeavyStunBuildup", "EnemyImmobilisationBuildup"  } },
	}, },
	{ label = "Pin Buildup", haveOutput = "PinBuildupOnHit", { format = "{1:output:PinBuildupOnHit}%",
		{ breakdown = "PinBuildup" }, 
		{ label = "Player modifiers", modName = { "EnemyElectrocuteBuildup", "EnemyFreezeBuildup", "EnemyHeavyStunBuildup", "EnemyPinBuildup", "EnemyImmobilisationBuildup"  } },
	}, },
} }
} },
