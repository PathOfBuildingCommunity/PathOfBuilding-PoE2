...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Ward Cost", color = colorCodes.WARD, haveOutput = "RunicWardHasCost", { format = "{0:output:RunicWardCost}", { breakdown = "RunicWardCost" }, { modName = { "RunicWardCost", "Cost", "RunicWardCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Ward per second", color = colorCodes.WARD, haveOutput = "RunicWardPerSecondHasCost", { format = "{2:output:RunicWardPerSecondCost}", { breakdown = "RunicWardPerSecondCost" }, { modName = { "RunicWardCost", "Cost", "RunicWardCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Ward % per second", color = colorCodes.WARD, haveOutput = "RunicWardPercentPerSecondHasCost", { format = "{2:output:RunicWardPercentPerSecondCost}", { breakdown = "RunicWardPercentPerSecondCost" }, { modName = { "RunicWardCost", "Cost", "RunicWardCostNoMult" }, cfg = "skill" }, }, },
...
{ 1, "RunicWard", 2, colorCodes.WARD, {{ defaultCollapsed = false, label = "Runic Ward", data = {
	extra = "{0:output:RunicWard}",
	{ label = "Base from Armours", { format = "{0:output:Gear:RunicWard}", { breakdown = "RunicWard", gearOnly = true }, }, },
	{ label = "Global Base", { format = "{0:mod:1}", { modName = "RunicWard", modType = "BASE" }, }, },
	{ label = "Inc. from Tree", { format = "{0:mod:1}%", { modName = "RunicWard", modType = "INC", modSource = "Tree" }, }, },
	{ label = "Total Increased", { format = "{0:mod:1}%", { modName = { "RunicWard", "Defences" }, modType = "INC" }, }, },
	{ label = "Total More", { format = "{0:mod:1}%", { modName = { "RunicWard", "Defences" }, modType = "MORE" }, }, },
	{ label = "Total", { format = "{0:output:RunicWard}", { breakdown = "RunicWard" }, }, },
	{ label = "Recovery", { format = "{1:output:RunicWardRegenRecovery} ({1:output:RunicWardRegenPercent}%)",
		{ breakdown = "RunicWardRegenRecovery" },
		{ label = "Sources", modName = { "RunicWardRegen", "RunicWardRegenPercent", "RunicWardDegen", "RunicWardDegenPercent", "RunicWardRecovery" }, modType = "BASE" },
		{ label = "Increased Runic Ward Recovery", modName = { "RunicWardRegen", "RunicWardRecoveryRate" }, modType = "INC" },
		{ label = "More Runic Ward Recovery", modName = { "RunicWardRegen", "RunicWardRecoveryRate" }, modType = "MORE" },
	}, },
} }
} },
-- secondary defenses
...
{ 1, "DamageAvoidance", 3, colorCodes.DEFENCE, { { defaultCollapsed = false, label = "Damage Avoidance", data = {
	...
	{ label = "Ward on Block", haveOutput = "RunicWardOnBlock", { format = "{0:output:RunicWardOnBlock}", { modName = "RunicWardOnBlock" }, }, },
