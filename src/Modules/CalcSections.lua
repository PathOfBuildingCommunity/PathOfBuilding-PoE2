...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Ward Cost", color = colorCodes.WARD, haveOutput = "WardHasCost", { format = "{0:output:WardCost}", { breakdown = "WardCost" }, { modName = { "WardCost", "Cost", "WardCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Ward per second", color = colorCodes.WARD, haveOutput = "WardPerSecondHasCost", { format = "{2:output:WardPerSecondCost}", { breakdown = "WardPerSecondCost" }, { modName = { "WardCost", "Cost", "WardCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Ward % per second", color = colorCodes.WARD, haveOutput = "WardPercentPerSecondHasCost", { format = "{2:output:WardPercentPerSecondCost}", { breakdown = "WardPercentPerSecondCost" }, { modName = { "WardCost", "Cost", "WardCostNoMult" }, cfg = "skill" }, }, },
...
{ 1, "Ward", 2, colorCodes.WARD, {{ defaultCollapsed = false, label = "Runic Ward", data = {
	...
	{ label = "Recovery", { format = "{1:output:WardRegenRecovery} ({1:output:WardRegenPercent}%)",
		...
		{ label = "Increased Ward Recovery", modName = { "WardRegen", "WardRecoveryRate" }, modType = "INC" },
		{ label = "More Ward Recovery", modName = { "WardRegen", "WardRecoveryRate" }, modType = "MORE" },
	}, },
} }
} },
-- secondary defenses
