...
{ 1, "EleAilments", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Non-Damaging Ailments", data = {
	...
	{ label = "Freeze Buildup", haveOutput = "FreezeBuildupOnHit", { format = "{1:output:FreezeBuildupOnHit}%",
		...
		{ label = "Enemy modifiers", modName = { "PoiseThreshold", "EnemyFreezeThreshold", "FreezeBuildup", "ImmobilisationBuildup"  }, enemy = true },
	}, },
	{ label = "Electrocute Buildup", haveOutput = "ElectrocuteBuildupOnHit", { format = "{1:output:ElectrocuteBuildupOnHit}%",
		...
		{ label = "Enemy modifiers", modName = { "PoiseThreshold", "EnemyElectrocuteThreshold", "ElectrocuteBuildup", "ImmobilisationBuildup" }, enemy = true },
	}, },
