...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Infernal Flame Cost", color = colorCodes.FIRE, haveOutput = "InfernalFlameMax", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { modName = { "ManaCost", "Cost", "ManaCostNoMult" }, cfg = "skill" }, }, },
...
{ 1, "Life", 2, colorCodes.LIFE, {{ defaultCollapsed = false, label = "Life", data = {
	...
	{ label = "Recoup", haveOutput = "LifeRecoup", { format = "{1:output:LifeRecoup}%", { breakdown = "LifeRecoup" }, 
		...
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
	{ label = "Recoup Duration", haveOutput = "LifeRecoup", { format = "{2:output:LifeRecoupDuration}s",
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
	{ label = "Phys Prevented Recoup", haveOutput = "PhysicalDamagePreventedLifeRecoup", { format = "{1:output:PhysicalDamagePreventedLifeRecoup}%", { breakdown = "PhysicalDamagePreventedLifeRecoup" }, 
		{ label = "Sources", modName = "PhysicalDamagePreventedLifeRecoup" },
		{ label = "Recovery modifiers", modName = "LifeRecoveryRate" },
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
	{ label = "Deflect Recoup", haveOutput = "DeflectedLifeRecoup", { format = "{1:output:DeflectedLifeRecoup}%", { breakdown = "DeflectedLifeRecoup" }, 
		{ label = "Sources", modName = "LifeRecoupFromDeflectedHits" },
		{ label = "Recovery modifiers", modName = "LifeRecoveryRate" },
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
...
{ 1, "Mana", 2, colorCodes.MANA, {{ defaultCollapsed = false, label = "Mana", data = {
	...
	notFlag = "minionSkill",
	{ label = "Infernal Flame", haveOutput = "InfernalFlameMax", { format = "{0:output:InfernalFlame}/{0:output:InfernalFlameMax}", { breakdown = "InfernalFlameMax" }, { modName = { "InfernalFlameManaRatio" } }, }, },
	{ label = "Overflow Hit", haveOutput = "InfernalFlameOverflowTaken", { format = "{0:output:InfernalFlameOverflowTaken}", { breakdown = "InfernalFlameOverflowTaken" }, { modName = { "InfernalFlameOverflowSelfHit" } }, }, },
	{ label = "Overflows/sec", haveOutput = "InfernalFlameOverflowsPerSecond", { format = "{2:output:InfernalFlameOverflowsPerSecond}", { breakdown = "InfernalFlameOverflowsPerSecond" }, }, },
	...
	{ label = "Recoup", haveOutput = "ManaRecoup", { format = "{1:output:ManaRecoup}%", { breakdown = "ManaRecoup" }, 
		...
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
	{ label = "Recoup Duration", haveOutput = "ManaRecoup", { format = "{2:output:ManaRecoupDuration}s",
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
	{ label = "Blocked Recoup", haveOutput = "BlockedManaRecoup", { format = "{1:output:BlockedManaRecoup}%", { breakdown = "BlockedManaRecoup" }, 
		{ label = "Sources", modName = "DamageBlockedManaRecoup" },
		{ label = "Recovery modifiers", modName = "ManaRecoveryRate" },
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
} }
...
{ 1, "EnergyShield", 2, colorCodes.ES, {{ defaultCollapsed = false, label = "Energy Shield", data = {
	...
	{ label = "Recoup Duration", haveOutput = "EnergyShieldRecoup", { format = "{2:output:EnergyShieldRecoupDuration}s",
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "4SecondEnergyShieldRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
	{ label = "Phys Prevented Recoup", haveOutput = "PhysicalDamagePreventedEnergyShieldRecoup", { format = "{1:output:PhysicalDamagePreventedEnergyShieldRecoup}%", { breakdown = "PhysicalDamagePreventedEnergyShieldRecoup" }, 
		{ label = "Sources", modName = "PhysicalDamagePreventedEnergyShieldRecoup" },
		{ label = "Recovery modifiers", modName = "EnergyShieldRecoveryRate" },
		{ label = "FasterRecoup", modName = { "4SecondRecoup", "4SecondEnergyShieldRecoup", "3SecondRecoup", "RecoupSpeed" } },
	}, },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
...
} }, { defaultCollapsed = false, label = "Infernal Flame Overflow Recoup", haveOutput = "InfernalFlameOverflowTaken", data = {
	colWidth = 250,
	extra = colorCodes.LIFE.."{1:output:InfernalFlameOverflowLifeRecoupStacked}/s net {0:output:InfernalFlameOverflowLifeNetPerOverflow}, "..colorCodes.ES.."{1:output:InfernalFlameOverflowEnergyShieldRecoupStacked}/s",
	{
		{ format = colorCodes.LIFE.."Life:" },
		{ format = colorCodes.ES.."Energy Shield:" },
	},
	{ label = "Overflow taken", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{0:output:InfernalFlameOverflowTaken}", { breakdown = "InfernalFlameOverflowTaken" }, },
		{ format = "{0:output:InfernalFlameOverflowTaken}", { breakdown = "InfernalFlameOverflowTaken" }, },
	},
	{ label = "Recoup %", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{1:output:InfernalFlameOverflowLifeRecoupPct}%", { label = "Sources", modName = { "LifeRecoup", "FireLifeRecoup", "LifeRecoveryRate" } }, },
		{ format = "{1:output:InfernalFlameOverflowEnergyShieldRecoupPct}%", { label = "Sources", modName = { "EnergyShieldRecoup", "FireEnergyShieldRecoup", "EnergyShieldRecoveryRate" } }, },
	},
	{ label = "Recouped per overflow", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{0:output:InfernalFlameOverflowLifeRecoupAmount}", { breakdown = "InfernalFlameOverflowLifeRecoupAmount" }, },
		{ format = "{0:output:InfernalFlameOverflowEnergyShieldRecoupAmount}", { breakdown = "InfernalFlameOverflowEnergyShieldRecoupAmount" }, },
	},
	{ label = "Recoup duration", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{2:output:InfernalFlameOverflowLifeRecoupDuration}s", { label = "Faster Recoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } }, },
		{ format = "{2:output:InfernalFlameOverflowEnergyShieldRecoupDuration}s", { label = "Faster Recoup", modName = { "4SecondRecoup", "4SecondEnergyShieldRecoup", "3SecondRecoup", "RecoupSpeed" } }, },
	},
	{ label = "Recoup/s (one overflow)", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{1:output:InfernalFlameOverflowLifeRecoupOne}", { breakdown = "InfernalFlameOverflowLifeRecoupOne" }, },
		{ format = "{1:output:InfernalFlameOverflowEnergyShieldRecoupOne}", { breakdown = "InfernalFlameOverflowEnergyShieldRecoupOne" }, },
	},
	{ label = "Time between overflows", haveOutput = "InfernalFlameOverflowInterval",
		{ format = "{2:output:InfernalFlameOverflowInterval}s", { breakdown = "InfernalFlameOverflowInterval" }, },
		{ format = "{2:output:InfernalFlameOverflowInterval}s", { breakdown = "InfernalFlameOverflowInterval" }, },
	},
	{ label = "Overlapping instances", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{2:output:InfernalFlameOverflowLifeOverlap}", { breakdown = "InfernalFlameOverflowLifeRecoupStacked" }, },
		{ format = "{2:output:InfernalFlameOverflowEnergyShieldOverlap}", { breakdown = "InfernalFlameOverflowEnergyShieldRecoupStacked" }, },
	},
	{ label = "Recoup/s (stacked)", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{1:output:InfernalFlameOverflowLifeRecoupStacked}", { breakdown = "InfernalFlameOverflowLifeRecoupStacked" }, },
		{ format = "{1:output:InfernalFlameOverflowEnergyShieldRecoupStacked}", { breakdown = "InfernalFlameOverflowEnergyShieldRecoupStacked" }, },
	},
	{ label = "Recovered over duration", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{0:output:InfernalFlameOverflowLifeRecoupOverDuration}", { breakdown = "InfernalFlameOverflowLifeRecoupOverDuration" }, },
		{ format = "{0:output:InfernalFlameOverflowEnergyShieldRecoupOverDuration}", { breakdown = "InfernalFlameOverflowEnergyShieldRecoupOverDuration" }, },
	},
	{ label = "Net per overflow", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{0:output:InfernalFlameOverflowLifeNetPerOverflow}", { breakdown = "InfernalFlameOverflowLifeNetPerOverflow" }, },
		{ format = "{0:output:InfernalFlameOverflowEnergyShieldNetPerOverflow}", { breakdown = "InfernalFlameOverflowEnergyShieldNetPerOverflow" }, },
	},
	{ label = "Time to recoup hit", haveOutput = "InfernalFlameOverflowTaken",
		{ format = "{2:output:InfernalFlameOverflowLifeTimeToRecoup}s", { breakdown = "InfernalFlameOverflowLifeTimeToRecoup" }, },
		{ format = "{2:output:InfernalFlameOverflowEnergyShieldTimeToRecoup}s", { breakdown = "InfernalFlameOverflowEnergyShieldTimeToRecoup" }, },
	},
	...
	{ label = "Recoup Max.", haveOutput = "anyRecoup", 
		{ format = "{0:output:LifeRecoupRecoveryMax}",
			...
			{ label = "Sources", modName = { "LifeRecoup", "PhysicalLifeRecoup", "LightningLifeRecoup", "ColdLifeRecoup", "FireLifeRecoup", "ChaosLifeRecoup", "PhysicalDamagePreventedLifeRecoup", "LifeRecoupFromDeflectedHits", "LifeRecoupFromRedirected", "PhysicalDamageMitigatedLifePseudoRecoup" } },
			{ label = "Recovery modifiers", modName = "LifeRecoveryRate" },
			{ label = "Faster Recoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
		},
		{ format = "{0:output:ManaRecoupRecoveryMax}",
			{ breakdown = "ManaRecoupRecoveryMax" },
			{ label = "Sources", modName = { "ManaRecoup", "DamageBlockedManaRecoup", "PhysicalDamagePreventedManaRecoup", "ChaosDamagePreventedManaRecoup" } },
			{ label = "Recovery modifiers", modName = "ManaRecoveryRate" },
			{ label = "Faster Recoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
		},
		{ format = "{0:output:EnergyShieldRecoupRecoveryMax}",
			{ breakdown = "EnergyShieldRecoupRecoveryMax" },
			{ label = "Sources", modName = { "EnergyShieldRecoup", "ElementalEnergyShieldRecoup", "PhysicalEnergyShieldRecoup", "LightningEnergyShieldRecoup", "ColdEnergyShieldRecoup", "FireEnergyShieldRecoup", "ChaosEnergyShieldRecoup", "PhysicalDamagePreventedEnergyShieldRecoup", "PerAbsorptionElementalEnergyShieldRecoup", "PhysicalDamageMitigatedEnergyShieldPseudoRecoup" } },
			{ label = "Recovery modifiers", modName = "EnergyShieldRecoveryRate" },
			{ label = "Faster Recoup", modName = { "4SecondRecoup", "4SecondLifeRecoup", "3SecondLifeRecoup", "3SecondRecoup", "RecoupSpeed" } },
		},
	},
