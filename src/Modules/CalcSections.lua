...
{ 1, "Life", 2, colorCodes.LIFE, {{ defaultCollapsed = false, label = "Life", data = {
	...
	{ label = "Mitigation Recoup", haveOutput = "PhysicalDamageMitigatedLifeRecoup", { format = "{1:output:PhysicalDamageMitigatedLifeRecoup}%", { breakdown = "PhysicalDamageMitigatedLifeRecoup" }, 
		{ label = "Sources", modName = "PhysicalDamageMitigatedLifeRecoup" },
		{ label = "Recovery modifiers", modName = "LifeRecoveryRate" },
		{ label = "Recoup Speed", modName = { "4SecondRecoup", "RecoupSpeed" } },
	}, },
} }
...
{ 1, "EnergyShield", 2, colorCodes.ES, {{ defaultCollapsed = false, label = "Energy Shield", data = {
	...
	{ label = "Mitigation Regen", haveOutput = "PhysicalDamageMitigatedEnergyShieldRecoup", { format = "{1:output:PhysicalDamageMitigatedEnergyShieldRecoup}%", { breakdown = "PhysicalDamageMitigatedEnergyShieldRecoup" }, 
		{ label = "Sources", modName = "PhysicalDamageMitigatedEnergyShieldRecoup" },
		{ label = "Recovery modifiers", modName = "EnergyShieldRecoveryRate" },
	}, },
} }
} },
...
{ 3, "DamageTaken", 1, colorCodes.DEFENCE, {{ defaultCollapsed = false, label = "Damage Taken", data = {
...
} }, { defaultCollapsed = true, label = "Net Recovery Per Second", data = {
	colWidth = 190,
	...
	{ label = "Recoup Max", haveOutput = "anyRecoup", 
		{ format = "{0:output:LifeRecoupRecoveryMax}",
			...
			{ label = "Sources", modName = { "LifeRecoup", "PhysicalLifeRecoup", "LightningLifeRecoup", "ColdLifeRecoup", "FireLifeRecoup", "ChaosLifeRecoup", "PhysicalDamageMitigatedLifeRecoup" } },
			{ label = "Recovery modifiers", modName = "LifeRecoveryRate" },
			{ label = "Recoup Speed", modName = { "4SecondRecoup", "RecoupSpeed" } },
		},
		...
		{ format = "{0:output:EnergyShieldRecoupRecoveryMax}",
			...
			{ label = "Sources", modName = { "EnergyShieldRecoup", "ElementalEnergyShieldRecoup", "PhysicalDamageMitigatedEnergyShieldRecoup" } },
			{ label = "Recovery modifiers", modName = "EnergyShieldRecoveryRate" },
			{ label = "Recoup Speed", modName = { "4SecondRecoup", "RecoupSpeed" } },
		},
	},
	...
	{ label = "Hit Over Time Max", haveOutput = "preventedLifeLossTotal", color = colorCodes.LIFE,
		{ format = "{0:output:LifeLossLostMax}",
			{ breakdown = "LifeLossLostMax" },
			{ modName = { "LifeLossPrevented" } },
		},
	},
	{ label = "Hit Over Time Avg.", haveOutput = "preventedLifeLossTotal", color = colorCodes.LIFE,
