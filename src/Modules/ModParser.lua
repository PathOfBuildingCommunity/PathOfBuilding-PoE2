...
local modNameList = {
	...
	["physical damage taken recouped as energy shield"] = "PhysicalEnergyShieldRecoup",
	["lightning damage taken recouped as energy shield"] = "LightningEnergyShieldRecoup",
	["cold damage taken recouped as energy shield"] = "ColdEnergyShieldRecoup",
	["fire damage taken recouped as energy shield"] = "FireEnergyShieldRecoup",
	["chaos damage taken recouped as energy shield"] = "ChaosEnergyShieldRecoup",
	...
	["physical damage taken recouped as mana"] = "PhysicalManaRecoup",
	["lightning damage taken recouped as mana"] = "LightningManaRecoup",
	["cold damage taken recouped as mana"] = "ColdManaRecoup",
	["fire damage taken recouped as mana"] = "FireManaRecoup",
	["chaos damage taken recouped as mana"] = "ChaosManaRecoup",
	["damage taken recouped as life, mana and energy shield"] = { "LifeRecoup", "EnergyShieldRecoup", "ManaRecoup" },
	["damage taken recouped as life and energy shield"] = { "LifeRecoup", "EnergyShieldRecoup" },
	["damage taken recouped as life and mana"] = { "LifeRecoup", "ManaRecoup" },
	["physical damage prevented recouped as life"] = "PhysicalDamagePreventedLifeRecoup",
	["physical damage prevented recouped as energy shield"] = "PhysicalDamagePreventedEnergyShieldRecoup",
	["physical damage prevented recouped as mana"] = "PhysicalDamagePreventedManaRecoup",
	["chaos damage you prevent when hit recouped as life and mana"] = { "ChaosDamagePreventedLifeRecoup", "ChaosDamagePreventedManaRecoup" },
	["chaos damage prevented recouped as life"] = "ChaosDamagePreventedLifeRecoup",
	["chaos damage prevented recouped as mana"] = "ChaosDamagePreventedManaRecoup",
	["damage taken from deflected hits recouped as life"] = "LifeRecoupFromDeflectedHits",
...
local modTagList = {
	...
	["per enemy power"] = { tag = { type = "Multiplier", var = "EnemyPower" } },
	...
	["from enemies with an open weakness"] = { tag = { type = "Condition", var = "EnemyHasOpenWeakness" } },
...
local specialModList = {
	...
	["maximum mana is replaced by twice as much maximum infernal flame"] = { flag("PyromanticPact"), mod("InfernalFlameManaRatio", "BASE", 2) },
	["maximum mana is replaced by maximum infernal flame"] = { flag("PyromanticPact"), mod("InfernalFlameManaRatio", "BASE", 1) },
	["gain infernal flame instead of spending mana for skill costs"] = { flag("GainInfernalFlameInsteadOfManaCost") },
	["take maximum life and energy shield as fire damage when infernal flame reaches maximum"] = { flag("InfernalFlameOverflowSelfHit") },
	["lose all infernal flame on reaching maximum infernal flame"] = { flag("InfernalFlameResetsOnMaximum") },
	["(%d+)%% of infernal flame lost per second if none was gained in the past 2 seconds"] = function(num) return { mod("InfernalFlameDecayPercent", "BASE", num) } end,
	["gain elemental archon when you cast a spell while on high infernal flame"] = { flag("Condition:CanGainElementalArchon", { type = "Condition", var = "HighInfernalFlame" }) },
	["elemental archon does not expire while on high infernal flame"] = { flag("ElementalArchonDoesNotExpire", { type = "Condition", var = "HighInfernalFlame" }) },
	["lose elemental archon on reaching maximum infernal flame"] = { flag("LoseElementalArchonOnMaximumInfernalFlame") },
	...
	["life recoup recovers energy shield instead"] = { flag("LifeRecoupAppliesToEnergyShieldInstead") },
	["damage blocked is recouped as mana"] = { mod("DamageBlockedManaRecoup", "BASE", 100) },
	["(%d+)%% of damage blocked is recouped as mana"] = function(num) return { mod("DamageBlockedManaRecoup", "BASE", num) } end,
	["recoup (%d+)%% of damage taken by your totems as life"] = function(num) return { mod("TotemDamageTakenLifeRecoup", "BASE", num) } end,
	["you recoup (%d+)%% of damage taken by your offerings as life"] = function(num) return { mod("OfferingDamageTakenLifeRecoup", "BASE", num) } end,
