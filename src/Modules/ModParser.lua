...
local specialModList = {
	...
	["non%-minion skills have (%d+)%% less reservation efficiency"] = function(num) return { mod("ReservationEfficiency", "INC", -num, { type = "SkillType", skillType = SkillType.Minion, neg = true }) } end,
