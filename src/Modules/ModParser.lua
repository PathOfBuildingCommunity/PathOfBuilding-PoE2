...
local specialModList = {
	...
	["(%d+)%% less reservation efficiency of non%-companion skills"] = function(num) return { mod("ReservationEfficiency", "MORE", -num, { type = "SkillType", skillType = SkillType.CreatesCompanion, neg = true }) } end,
