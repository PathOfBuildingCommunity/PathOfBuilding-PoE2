...
local specialModList = {
	...
	["grenades have (%d+)%% chance to activate a second time"] = function(num) return { mod("Damage", "MORE", num, nil, ModFlag.Projectile, { type = "SkillType", skillType = SkillType.Grenade })} end,
