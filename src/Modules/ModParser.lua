...
local specialModList = {
	...
	["enemies in your presence gain critical weakness every second"] = { flag("ApplyBrittleStacks") },
	["applies critical weakness to enemies every ([%d%.]+) seconds?"] = { flag("ApplyBrittleStacks") },
	["inflicts critical weakness on hit"] = { flag("ApplyBrittleStacks") },
