...
local specialModList = {
	...
	["buffs on you expire (%d+)%% faster"] = function(num) return { mod("SelfBuffExpirationRate", "BASE", num) } end,
	["buffs on you expire (%d+)%% slower"] = function(num) return { mod("SelfBuffExpirationRate", "BASE", -num) } end,
