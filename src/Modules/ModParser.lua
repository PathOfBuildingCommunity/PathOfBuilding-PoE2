...
local modNameList = {
	...
	["runic ward regeneration rate"] = "RunicWardRegen",
	["mana cost"] = "ManaCost",
	...
	["runic ward cost efficiency"] = "RunicWardCostEfficiency",
	...
	["restoration of ward"] = "RunicWardRechargeFaster",
	["armour"] = "Armour",
	["evasion"] = "Evasion",
	["evasion rating"] = "Evasion",
	["energy shield"] = "EnergyShield",
	["runic ward"] = "RunicWard",
	["maximum runic ward"] = "RunicWard",
...
local modTagList = {
	...
	["per (%d+) maximum runic ward"] = function(num) return { tag = { type = "PerStat", stat = "RunicWard", div = num } } end,
...
local specialModList = {
	...
	["recover (%d+) runic ward when you block"] = function(num) return { mod("RunicWardOnBlock", "BASE", num) } end,
	...
	["gain ward instead of (%d+)%% of armour and evasion rating from equipped body armour"] = function(num) return {flag("ConvertBodyArmourArmourEvasionToRunicWard"), mod("BodyArmourArmourEvasionToWardPercent", "BASE", num)} end,
	...
	["gain added chaos damage equal to (%d+)%% of ward"] = function(num) return {
		mod("ChaosMin", "BASE", 1, { type = "PercentStat", stat = "RunicWard", percent = num }),
		mod("ChaosMax", "BASE", 1, { type = "PercentStat", stat = "RunicWard", percent = num }),
	} end,
...
local suffixTypes = {
	...
	["as extra maximum runic ward"] = "GainAsRunicWard",
