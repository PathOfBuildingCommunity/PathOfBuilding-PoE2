...
local preFlagList = {
	...
	["^companions [hd][ae][va][el] "] = { addToMinion = true, addToMinionTag = { type = "SkillType", skillType = SkillType.CreatesCompanion }, tag = { type = "SkillType", skillType = SkillType.CreatesCompanion } },
	-- Totem/trap/mine
