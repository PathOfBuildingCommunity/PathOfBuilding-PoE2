...
local preFlagList = {
	...
	["^skills that have dealt a critical hit in the past 8 seconds deal "] = { tag = { type = "Condition", var = "CritRecently" } },
...
local modTagList = {
	...
	["if you[' ]h?a?ve crit in the past 8 seconds"] = { tag = { type = "Condition", var = "CritRecently" } },
	["if you[' ]h?a?ve dealt a crit in the past 8 seconds"] = { tag = { type = "Condition", var = "CritRecently" } },
	["if you[' ]h?a?ve dealt a critical hit in the past 8 seconds"] = { tag = { type = "Condition", var = "CritRecently" } },
