...
function CustomModBlockClass:CustomModBlockControl(anchor, rect, configTab, blockIndex, blockData)
	...
	self.controls.addModBtn = new("ButtonControl"):ButtonControl({ "LEFT", self.controls.titleEdit, "RIGHT" }, { 6, 0, 48, 18 }, "^7+ Mod", function()
...
function ConfigTabClass:ConfigTab(build)
	...
	if self.customSection then
		self.controls.customModsAddBlock = new("ButtonControl"):ButtonControl({ "TOPLEFT", self.customSection, "TOPLEFT" }, { 8, 0, 75, 20 }, "^7+ Block", function()
...
function ConfigTabClass:OpenAddModPopup(blockData)
	...
	controls.listControl = new("ListControl"):ListControl({ "TOPLEFT", nil, "TOPLEFT" }, { 10, 20, 580, 184 }, 16, "VERTICAL", false, displayList)
	...
	controls.searchLabel = new("LabelControl"):LabelControl({ "TOPRIGHT", nil, "TOPLEFT" }, { 65, 212, 0, 16 }, "^7Search:")
	controls.search = new("EditControl"):EditControl({ "TOPLEFT", nil, "TOPLEFT" }, { 70, 212, 520, 18 }, "", nil, "%c", 100, function()
		updateDisplayList()
	end)

	updateDisplayList()

	controls.save = new("ButtonControl"):ButtonControl(nil, { -45, 242, 80, 20 }, "Add", function()
	...
	controls.close = new("ButtonControl"):ButtonControl(nil, { 45, 242, 80, 20 }, "Cancel", function()
		main:ClosePopup()
	end)
