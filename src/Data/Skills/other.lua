...
skills["ArbitersReachWardPlayer"] = {
	...
	statSets = {
		[1] = {
			label = "Arbiter's Reach",
			incrementalEffectiveness = 0.054999999701977,
			statDescriptionScope = "gem_stat_descriptions",
			baseFlags = {
			},
			constantStats = {
				{ "support_mothers_ward_base_duration_ms", 4000 },
			},
			stats = {
			},
			levels = {
...
skills["SupportMorrigansInsight"] = {
	...
	statSets = {
		[1] = {
			label = "Morrigan's Insight",
			incrementalEffectiveness = 0.054999999701977,
			statDescriptionScope = "gem_stat_descriptions",
			statMap = {
				["support_morrigans_refuge_damage_+%_final_vs_frozen_enemies"] = {
		...
		[1] = {
			...
			statMap = {
				["morrigan_ward_thorns_minimum_base_cold_damage"] = {
					mod("ColdMin", "BASE", nil, ModFlag.Thorns, 0, { type = "GlobalEffect", effectType = "Buff", effectName = "Nature's Exchange"}),
				},
				["morrigan_ward_thorns_maximum_base_cold_damage"] = {
					mod("ColdMax", "BASE", nil, ModFlag.Thorns, 0, { type = "GlobalEffect", effectType = "Buff", effectName = "Nature's Exchange"}),
				},
			},
			baseFlags = {
				duration = true,
...
skills["SupportStyrnsFerocity"] = {
	...
	statSets = {
		[1] = {
			...
			statDescriptionScope = "gem_stat_descriptions",
			statMap = {
				["support_knights_ferocity_crush_on_hit_ms"] = {
					mod("MinionModifier", "LIST", { mod = mod("Damage", "INC", nil, 0, 0, { type = "PerStat", stat = "Str", actor = "parent" }) }),
					flag("Condition:Crushed", { type = "GlobalEffect", effectType = "Debuff" })
				},
			},
			baseFlags = {
			},
...
skills["SupportStyrnsMountain"] = {
	...
	statSets = {
		[1] = {
			...
			statDescriptionScope = "gem_stat_descriptions",
			statMap = {
				["knights_legacy_non_active_blocking_melee_skill_damage_+%_final_to_grant_if_active_blocked_with_supported_skills_recently"] = {
					mod("Damage", "MORE", nil, 0, 0, { type = "GlobalEffect", effectType = "Buff", effectName = "Styrn's Mountain" }, { type = "SkillType", skillType = SkillType.ActiveBlock, neg = true }, { type = "Condition", var = "BlockedRecently" }),
				},
			},
			baseFlags = {
			},
...
skills["SupportUhtredsConstellation"] = {
	name = "Uhtred's Constellation",
	description = "Supports non-instant skills which have a cooldown, granting them two additional cooldown uses and more damage per different skill with a cooldown you have used recently.",
	color = 4,
	support = true,
	...
	isLineage = true,
	flavourText = {"\"In the stars, I see our future. My plans are laid,", "lines tracing a constellation. You may only see", "pieces, but I see the whole, and it will be glorious.\"", },
	levels = {
		[1] = { levelRequirement = 0, },
	},
	statSets = {
		[1] = {
			label = "Uhtred's Constellation",
			incrementalEffectiveness = 0.054999999701977,
			statDescriptionScope = "gem_stat_descriptions",
			baseFlags = {
			},
			constantStats = {
				{ "support_uhtred_damage_+%_final_per_different_cooldown_skill_in_last_8_seconds", 8 },
				{ "support_added_cooldown_count_if_not_instant", 2 },
...
skills["SupportUhtredsRitePlayer"] = {
	name = "Uhtred's Rite",
	description = "Supports skills with Cooldowns, causing them to grant Overflowing Chalice when used. Supported skills deal more damage during the effect of your Life Flask and have increased Mana Cost Efficiency during the effect of your Mana Flask.",
	color = 4,
	support = true,
	requireSkillTypes = { SkillType.Cooldown, },
	addSkillTypes = { SkillType.Duration, SkillType.Buff, },
	excludeSkillTypes = { },
	gemFamily = { "UhtredChalice",},
	isLineage = true,
	flavourText = {"\"To control the stars, we swallow the firmament.", "We imbibe the truth. We are filled with the void.", "We embrace the vast emptiness, or we die.\"", },
	levels = {
		[1] = { levelRequirement = 0, },
	},
	statSets = {
		[1] = {
			...
			statDescriptionScope = "gem_stat_descriptions",
			statMap = {
				["support_uhtreds_chalice_damage_+%_final_during_life_flask"] = {
					mod("Damage", "MORE", nil, 0, 0, { type = "Condition", var = "UsingLifeFlask" }),
				},
				["base_mana_cost_efficiency_+%_during_mana_flask"] = {
					mod("ManaCostEfficiency", "INC", nil, 0, 0, { type = "Condition", var = "UsingManaFlask" }),
				},
			},
			baseFlags = {
			},
			constantStats = {
				{ "support_uhtreds_chalice_buff_on_skill_use_duration_ms_per_1000_ms_cooldown", 1000 },
				{ "support_uhtreds_chalice_damage_+%_final_during_life_flask", 20 },
				{ "base_mana_cost_efficiency_+%_during_mana_flask", 20 },
			},
			stats = {
			},
			levels = {
...
skills["SupportVoranasSiege"] = {
	...
	statSets = {
		[1] = {
			...
			statDescriptionScope = "gem_stat_descriptions",
			statMap = {
				["support_voranas_siege_hit_damage_+%_final_vs_isolated_enemies"] = {
					mod("Damage", "MORE", nil, ModFlag.Hit, 0, { type = "ActorCondition", actor = "enemy", var = "Isolated" }),
				},
			},
			baseFlags = {
			},
