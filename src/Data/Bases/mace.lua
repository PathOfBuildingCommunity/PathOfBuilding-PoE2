...
itemBases["Smithing Hammer"] = {
	...
	socketLimit = 3,
	tags = { default = true, ezomyte_basetype = true, mace = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitIds = { "MaceImplicitFireDamage1", },
	implicitModTypes = { },
...
itemBases["Warpick"] = {
	...
	implicitIds = { "MaceImplicitCriticalMultiplier1", },
...
itemBases["Construct Hammer"] = {
	...
	implicitIds = { "MaceImplicitLocalDazeBuildup1", },
	implicitModTypes = { {  }, },
...
itemBases["Jade Club"] = {
	...
	implicitIds = { "MaceImplicitAlwaysHit1", },
...
itemBases["Runemastered Torment Club"] = {
	...
	implicitIds = { "OlrovasaraVerisiumWeaponImplicitDamageIsCold1", "OlrovasaraVerisiumImplicitLightningToCold1", },
...
itemBases["Runemastered Torment Club"] = {
	...
	implicitIds = { "OlrovasaraVerisiumImplicitDamageAsExtraLightningPerRunicWard1", },
	implicitModTypes = { {  }, },
	weapon = { PhysicalMin = 44, PhysicalMax = 73, CritChanceBase = 5, AttackRateBase = 1.45, Range = 13, },
	req = { level = 65, str = 114, },
}
itemBases["Runemastered Torment Club"] = {
	...
	implicitIds = { "OlrovasaraVerisiumImplicitWeaponRange1", },
	implicitModTypes = { { "attack" }, },
	weapon = { PhysicalMin = 44, PhysicalMax = 73, CritChanceBase = 5, AttackRateBase = 1.45, Range = 13, },
	req = { level = 65, str = 114, },
}
itemBases["Runemastered Torment Club"] = {
	...
	implicitIds = { "MjolnerVerisiumImplicitLocalLightningConvert1", "MjolnerVerisiumImplicitLightningDamage1", },
...
itemBases["Runemastered Torment Club"] = {
	...
	implicitIds = { "MjolnerVerisiumImplicitLightningChain1", },
	implicitModTypes = { {  }, },
	weapon = { PhysicalMin = 44, PhysicalMax = 73, CritChanceBase = 5, AttackRateBase = 1.45, Range = 13, },
	req = { level = 65, str = 114, },
}
...
itemBases["Kalguuran Forgehammer"] = {
	...
	implicitIds = { "MaceImplicitHasXSockets", },
	implicitModTypes = { {  }, },
...
itemBases["Runeforged Wooden Club"] = {
	...
	implicitIds = { "BrynhandsMarkVerisiumImplicitAreaOfEffect", },
	implicitModTypes = { { "attack" }, },
...
itemBases["Runeforged Slim Mace"] = {
	...
	socketLimit = 3,
	tags = { default = true, ezomyte_basetype = true, mace = true, one_hand_weapon = true, onehand = true, runeforged = true, weapon = true, },
	implicitIds = { "FrostBreathVerisiumImplicitLocalColdConvert1", },
	implicitModTypes = { },
...
itemBases["Runeforged Warpick"] = {
	...
	implicitIds = { "SculptedSufferingVerisiumImplicitArmourBreakEffect1", },
...
itemBases["Runeforged Kalguuran Forgehammer"] = {
	...
	implicitIds = { "MaceImplicitHasXSockets", "MaceImplicitWardUnique1", },
...
itemBases["Runeforged Morning Star"] = {
	...
	socketLimit = 3,
	tags = { default = true, karui_basetype = true, mace = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitIds = { "BrutusLeadSprinklerVerisiumImplicitLocalFireConvert1", },
	implicitModTypes = { },
...
itemBases["Oak Greathammer"] = {
	...
	implicitIds = { "MaceImplicitStunDamageIncrease1", },
	implicitModTypes = { {  }, },
...
itemBases["Forge Maul"] = {
	...
	implicitIds = { "MaceImplicitLocalCrushOnHit1", },
	implicitModTypes = { { "physical" }, },
...
itemBases["Cultist Greathammer"] = {
	...
	implicitIds = { "MaceImplicitSplashDamage1", },
	implicitModTypes = { { "attack" }, },
...
itemBases["Crumbling Maul"] = {
	...
	implicitIds = { "MaceImplicitEnemiesExplodeOnCrit1", },
	implicitModTypes = { {  }, },
...
itemBases["Totemic Greatclub"] = {
	...
	implicitIds = { "MaceImplicitWarcryExert1", },
	implicitModTypes = { { "attack" }, },
...
itemBases["Runeforged Studded Greatclub"] = {
	...
	implicitIds = { "BrainRattlerVerisiumImplicitLightningConvert1", },
	implicitModTypes = { },
...
itemBases["Runeforged Cultist Greathammer"] = {
	...
	implicitIds = { "MaceImplicitSplashDamage1", "EmptyRoarVerisiumBleedDuration1", },
...
itemBases["Ironwood Greathammer"] = {
	...
	implicitIds = { "MaceImplicitStunDamageIncrease2", },
	implicitModTypes = { {  }, },
...
itemBases["Runemastered Aberrant Sledge"] = {
	...
	implicitIds = { "TwistedEmpyreanVerisiumImplicitAdditionalFissures1", },
	implicitModTypes = { { "attack" }, },
	weapon = { PhysicalMin = 74, PhysicalMax = 154, CritChanceBase = 5, AttackRateBase = 1.2, Range = 15, },
	req = { level = 70, str = 163, },
}
itemBases["Runemastered Aberrant Sledge"] = {
	...
	implicitIds = { "TwistedEmpyreanVerisiumImplicitFreezeBuildup1", },
...
itemBases["Runemastered Aberrant Sledge"] = {
	...
	socketLimit = 4,
	tags = { default = true, mace = true, runeforged = true, two_hand_weapon = true, twohand = true, weapon = true, },
	implicitIds = { "TwistedEmpyreanVerisiumImplicitLocalColdConvert1", },
	implicitModTypes = { },
