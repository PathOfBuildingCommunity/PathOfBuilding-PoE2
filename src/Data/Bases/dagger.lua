...
itemBases["Crone Knife"] = {
	...
	implicitIds = { "DaggerImplicitManaLeechLocal1" },
...
itemBases["Moon Dagger"] = {
	...
	socketLimit = 3,
	tags = { dagger = true, default = true, maraketh_basetype = true, one_hand_weapon = true, onehand = true, weapon = true, },
	implicitIds = { "DaggerImplicitColdDamage1" },
	implicitModTypes = { },
...
itemBases["Bloodletting Dagger"] = {
	...
	implicitIds = { "DaggerImplicitSpellLifeCostPercent1" },
...
itemBases["Mail Breaker"] = {
	...
	implicitIds = { "DaggerImplicitBreakArmour1" },
	implicitModTypes = { {  }, },
