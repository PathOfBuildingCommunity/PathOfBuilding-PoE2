...
c["Skeletal Minions you would create instead grant you Umbral Souls for each Minion you would have created"]={{[1]={flags=0,keywordFlags=0,name="UmbralWell",type="FLAG",value=true},[2]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalWarrior"},flags=1,keywordFlags=0,name="Damage",type="INC",value=15},[3]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalSniper"},flags=0,keywordFlags=0,name="ProjectileSpeed",type="INC",value=15},[4]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalCleric"},flags=0,keywordFlags=0,name="EnergyShieldRecharge",type="INC",value=30},[5]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalArsonist"},flags=0,keywordFlags=0,name="AreaOfEffect",type="INC",value=15},[6]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalStormMage"},flags=2,keywordFlags=0,name="Damage",type="INC",value=25},[7]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalFrostMage"},flags=0,keywordFlags=0,name="EnergyShield",type="INC",value=35},[8]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalBrute"},flags=0,keywordFlags=0,name="EnemyHeavyStunBuildup",type="INC",value=60},[9]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalReaver"},flags=0,keywordFlags=0,name="Speed",type="INC",value=6},[10]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalReaver"},flags=0,keywordFlags=0,name="WarcrySpeed",type="INC",value=6},[11]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalReaver"},flags=0,keywordFlags=0,name="TotemPlacementSpeed",type="INC",value=6},[12]={[1]={effectName="Umbral Well",effectType="Buff",type="GlobalEffect"},[2]={type="Multiplier",var="UmbralWellSkeletalReaver"},flags=0,keywordFlags=0,name="ReloadSpeed",type="INC",value=6}},nil}
