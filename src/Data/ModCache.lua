...
c["Bow Attacks consume 10% of your maximum Life Flask Charges if possible to deal added Physical damage equal to 10% of Flask's Life Recovery amount"]={{[1]={[1]={div=10,type="Multiplier",var="LifeFlaskRecovery"},flags=131072,keywordFlags=0,name="PhysicalMin",type="BASE",value=1},[2]={[1]={div=10,type="Multiplier",var="LifeFlaskRecovery"},flags=131072,keywordFlags=0,name="PhysicalMax",type="BASE",value=1}},nil}
c["Bow Attacks consume 10% of your maximum Life Flask Charges if possible to deal added Physical damage equal to 5% of Flask's Life Recovery amount"]={{[1]={[1]={div=20,type="Multiplier",var="LifeFlaskRecovery"},flags=131072,keywordFlags=0,name="PhysicalMin",type="BASE",value=1},[2]={[1]={div=20,type="Multiplier",var="LifeFlaskRecovery"},flags=131072,keywordFlags=0,name="PhysicalMax",type="BASE",value=1}},nil}
c["Bow Attacks consume 10% of your maximum Life Flask Charges if possible to deal added Physical damage equal to 8% of Flask's Life Recovery amount"]={{[1]={[1]={div=12.5,type="Multiplier",var="LifeFlaskRecovery"},flags=131072,keywordFlags=0,name="PhysicalMin",type="BASE",value=1},[2]={[1]={div=12.5,type="Multiplier",var="LifeFlaskRecovery"},flags=131072,keywordFlags=0,name="PhysicalMax",type="BASE",value=1}},nil}
