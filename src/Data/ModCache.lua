...
c["Companions gain added Attack damage equal to 60% of your main hand Weapon's damage"]={{[1]={[1]={skillType=219,type="SkillType"},flags=0,keywordFlags=0,name="ExtraAura",type="LIST",value={mod={flags=0,keywordFlags=0,name="GainMainHandDmgFromParent",type="FLAG",value=true},onlyAllies=true}},[2]={[1]={skillType=219,type="SkillType"},flags=0,keywordFlags=0,name="Multiplier:MainHandDamageToAllies",type="BASE",value=60}},nil}
