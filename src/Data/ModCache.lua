...
c["Inevitable Critical Hits"]={{[1]={flags=0,keywordFlags=0,name="ForcedOutcome",type="FLAG",value=true},[2]={[1]={type="Condition",var="Combat"},flags=0,keywordFlags=0,name="Condition:CritRecently",source="Config",type="FLAG",value=true}},nil}
