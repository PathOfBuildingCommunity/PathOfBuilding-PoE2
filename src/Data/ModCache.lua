...
c["+3 to Level of all Ice Fragments Skills"]={{[1]={flags=0,keywordFlags=0,name="GemProperty",type="LIST",value={key="level",keyOfScaledMod="value",keyword="ice fragments",value=3}}},nil}
...
c["+3 to Level of all Shred Skills"]={{[1]={flags=0,keywordFlags=0,name="GemProperty",type="LIST",value={key="level",keyOfScaledMod="value",keyword="shred",value=3}}},nil}
