...
c["Gain 1 Rage on Melee Hit"]={{[1]={flags=0,keywordFlags=0,name="RageOnMeleeHit",type="BASE",value=1},[2]={flags=0,keywordFlags=0,name="Condition:CanGainRage",type="FLAG",value=true}},nil}
