...
c["Physical Damage Reduction from Armour is based on your combined Armour and Evasion Rating"]={{[1]={flags=0,keywordFlags=0,name="EvasionAddsToPdr",type="FLAG",value=true}},"Physical Damage Reduction from Armour is based on your combined Armour and Evasion Rating"}
